...
#######################################__ДОБАВЛЕНИЕ ЗАПИСИ__###########################################################
    ...
    def init_tables(self):
        ...
        self.set_custom_headers(self.vyst_mo_table_model, ["Код ВУЗа",
                                                           "Признак  формы  НИР", "Регистрационный номер НИР", "Наименование НИР",
        ...
        self.set_custom_headers(self.vuz_table_model,
                                ["Код ВУЗа", "Название ВУЗа", "Полное наименование ВУЗа", "Сокращенное наименование ВУЗа",
                                 "Федеральный округ", 'Город', "Статус", "№ области", "Область", "Категория", "Профиль"])
