...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.show_list = QAction(MainWindow)
        ...
        self.groups_pages.setGeometry(QRect(0, 0, 1181, 701))
        ...
        self.groups_pages.addWidget(self.group_list_page)
        ...
        self.layoutWidget3.setGeometry(QRect(10, 30, 151, 51))
        ...
        self.group_name = QLabel(self.group_view_page)
        ...
        self.groups_menu = QMenu(self.menuBar)
        self.groups_menu.setObjectName(u"groups_menu")
        self.groups_menu.setGeometry(QRect(352, 125, 182, 72))
        self.help = QMenu(self.menuBar)
        self.help.setObjectName(u"help")
        MainWindow.setMenuBar(self.menuBar)

        self.menuBar.addAction(self.tables_menu.menuAction())
        self.menuBar.addAction(self.groups_menu.menuAction())
        ...
        self.groups_menu.addAction(self.show_list)

        self.retranslateUi(MainWindow)

        self.pages_.setCurrentIndex(1)
        self.db_tables.setCurrentIndex(0)
        self.groups_pages.setCurrentIndex(1)
